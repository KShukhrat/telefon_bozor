...
class Product(models.Model):
    ...
    Yetkazib_berish = models.IntegerField(default=000, blank=True, null=True)
    Oldindan_tulov = models.IntegerField(default=000, blank=True, null=True)
    ...
    Narxi = models.IntegerField(default=000, blank=True, null=True)
    ...
    Aspekt_nisbati = models.CharField(max_length=100, null=True, blank=True)
    Ekranni_avtomatik_aylantirish = models.CharField(max_length=100, null=True, blank=True)
    ...
    foto_flesh = models.CharField(max_length=100, null=True, blank=True)
    ...
    Standart = models.CharField(max_length=100, null=True, blank=True)
    ...
    Karnay_urnatilgan_dinamik = models.CharField(max_length=100, null=True, blank=True)
    Boshqaruv = models.CharField(max_length=100, null=True, blank=True)
    Samolyot_rejimi = models.CharField(max_length=100, null=True, blank=True)
    Sensorlar = models.CharField(max_length=200, null=True, blank=True)
    id = models.UUIDField(default=uuid.uuid4, unique=True,
                          primary_key=True, editable=False)
